            ...
            {isHorizontal ? (
                <>
                    <div className="flex-shrink-0">
                        <span className={`material-symbols-outlined text-base sm:text-xl ${iconColor} bg-white/5 p-1.5 rounded-sm`}>{icon}</span>
                    </div>
                ...
                <>
                    <div className="flex justify-between items-start">
                        ...
                        <span className={`material-symbols-outlined text-base sm:text-xl ${iconColor}`}>{icon}</span>
                    </div>
