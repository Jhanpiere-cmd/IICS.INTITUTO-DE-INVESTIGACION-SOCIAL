                    ...
                    <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
                        <div className="flex flex-col">
                            <h1 className="text-2xl font-black text-white uppercase tracking-tighter leading-none flex items-center gap-3">
                                <span className="material-symbols-outlined text-exec-blue text-3xl">event</span>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            >
                                <span className="material-symbols-outlined text-exec-blue text-[18px]">calendar_month</span>
                            ...
                            >
                                <span className="material-symbols-outlined text-exec-blue text-[20px] group-hover:animate-pulse">smart_toy</span>
                    ...
                    <section className="flex justify-between items-center bg-[#0A0A0A] border border-[#262626] rounded-none p-4 shadow-subtle">
                        <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-none bg-exec-blue/10 border border-exec-blue/20 flex items-center justify-center">
                                <span className="material-symbols-outlined text-exec-blue text-xl">event</span>
                            </div>
                            <div>
