                    ...
                    <div className="flex-1 flex flex-col gmail-modal animate-in slide-in-from-right duration-300 h-full overflow-hidden">
                            ...
                            <div className="flex gap-4">
                                ...
                                <div className="flex items-center gap-3">
                                    <button onClick={handleDelete} className="flex items-center justify-center hover:bg-red-500/10 p-1.5 rounded-sm transition-colors group">
                                        <span className="material-symbols-outlined text-gray-500 group-hover:text-red-500 text-xl transition-colors">delete</span>
                                    </button>
                        ...
                        <div className="flex-1 overflow-y-auto stich-scrollbar p-0 bg-[#0A0A0A]">
                                ...
                                <div className="flex gap-3 min-w-0">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <div className="flex items-center gap-1">
                                            ...
                                            <span className="material-symbols-outlined text-gray-600 text-[14px]">arrow_drop_down</span>
                                        </div>
                                    </div>
                                </div>
                                <div className="flex flex-col items-end gap-1">
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <button onClick={handleReply}>
                                            <span className="material-symbols-outlined text-gray-600 hover:text-white cursor-pointer text-lg">reply</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            {selectedEmail.type === 'certificate' ? (
                                                <div className="text-center space-y-4">
                                                    <div className="w-16 h-16 bg-[#111111] border border-[#3B82F6]/30 rounded-full flex items-center justify-center mx-auto shadow-[0_0_20px_rgba(59,130,246,0.1)]">
                                                        <span className="material-symbols-outlined text-3xl text-[#3B82F6]">workspace_premium</span>
                                                    </div>
                                                    <div className="px-6">
                            ...
                            <div className="p-8 pt-0 flex gap-4">
                                ...
                                >
                                    <span className="material-symbols-outlined text-lg group-hover:rotate-[-45deg] transition-transform">reply</span>
                                    RESPONDER_CARGA
                                </button>
                                <button 
                                ...
                                >
                                    <span className="material-symbols-outlined text-lg group-hover:translate-x-1 transition-transform">forward</span>
                                    REENVIAR_TRAZA
                                </button>
                            </div>
                        </div>
                                    ...
                                    <div className="space-y-2">
                                        {(selectedEmail as any).attachments.map((file: any, idx: number) => (
                                            ...
                                            >
                                                ...
                                                <span className="material-symbols-outlined text-gray-700 text-sm">open_in_new</span>
                                            </a>
                                        ))}
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <h2 className="text-lg font-bold flex items-center gap-3 text-white uppercase tracking-widest">
                                            <span className="material-symbols-outlined text-[#3B82F6] text-sm">terminal</span>
                                            REDACTOR_CORREO_V15
                                        </h2>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    >
                                        {isSending ? (
                                            ...
                                            <><span className="material-symbols-outlined text-sm">rocket_launch</span>DESPLEGAR_AHORA</>
                                        )}
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="p-4 border-t border-[#262626] bg-[#050505]">
                                ...
                                >
                                    {isSending ? (
                                        ...
                                        <><span className="material-symbols-outlined text-sm">send</span>DESPLEGAR_AHORA</>
                                    )}
                                </button>
                            </div>
                        </div>
