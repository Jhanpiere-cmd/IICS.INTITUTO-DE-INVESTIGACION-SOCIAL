...
export const AboutSystem: React.FC = () => {
  ...
  const sections = [
    ...
    { id: 'team', label: 'Equipo ACS', icon: Users },
          ...
          <div className="text-center lg:text-left flex-1 space-y-6">
            <div>
              ...
              <h1 className="text-5xl md:text-6xl font-black text-white uppercase tracking-tighter leading-none">
                SGR <span className="text-blue-600">ACS</span>
              </h1>
            </div>
            <div className="max-w-2xl space-y-4">
              ...
              <p className="text-[10px] font-medium text-gray-500 uppercase tracking-[0.2em] leading-relaxed">
                Facultad de Ciencias Sociales / Universidad Nacional de Cajamarca <br />
                Protocolo de Comunicación y Marketing Estratégico
              </p>
            </div>
