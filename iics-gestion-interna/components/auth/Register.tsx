        ...
        <div className="w-full max-w-md space-y-6 my-auto pt-10 pb-10">
          <div className="text-center group">
            <div className="flex justify-center items-center gap-4 md:gap-6 mb-8 flex-wrap">
              ...
              <img src="/certificates/logo-revista/logo-revista-ACS.png" alt="Revista ACS" className="h-14 md:h-18 w-auto object-contain transition-all duration-500 hover:scale-110 drop-shadow-[0_0_15px_rgba(255,255,255,0.2)]" />
            ...
            <p className="text-sm text-gray-300 font-medium tracking-wide">SGR-ACS / Sistema de Gestión</p>
          ...
          <div className="mt-8 text-center pb-8 opacity-30">
            <p className="text-[8px] text-gray-200 uppercase tracking-[0.4em] font-medium">© 2026 SGR-ACS / FACULTAD DE CIENCIAS SOCIALES</p>
          </div>
        </div>
      </div>
    </div>
