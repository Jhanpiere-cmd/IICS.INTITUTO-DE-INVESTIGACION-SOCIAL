...
const Layout: React.FC = () => {
    ...
    const getPageTitle = (pathname: string) => {
        switch (pathname) {
            ...
            case '/events': return 'Eventos y Actividades';
            case '/news': return 'Noticias';
            case '/proposals': return 'Propuestas';
            case '/benefits': return 'Beneficios';
            case '/alliances': return 'Alianzas';
            case '/finance': return 'Gestión Financiera';
            case '/reports': return 'Reportes';
            case '/users': return 'Usuarios';
            case '/settings': return 'Configuración';
            case '/chat': return 'Asistente IA';
            case '/media': return 'Gestión Audiovisual';
    ...
    return (
        <div className={`flex h-screen bg-background text-foreground font-sans antialiased overflow-hidden`}>
            ...
            {/* Agente HOYR V2 y Sistema de Anuncios */}
            <AgentBubble />
            <SystemUpdateModal />
        </div>
    );
                ...
                <ToastProvider>
                    <ConfirmProvider>
                        <Routes>
                            ...
                            {/* Ruta pública de inscripción a eventos — sin autenticación */}
