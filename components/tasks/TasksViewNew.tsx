    ...
    <div className="w-full bg-black min-h-screen px-4 pb-4 pt-0 md:pt-4 md:px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        >
          <div className="flex justify-between items-start">
            ...
            <span className="material-symbols-outlined notranslate text-exec-blue text-xl group-hover:scale-110 transition-transform" translate="no">assignment_ind</span>
          </div>
          <div>
            ...
            <div className="flex items-center gap-1 text-xs text-exec-blue/80 mt-1">
              <span className="material-symbols-outlined notranslate text-[14px]" translate="no">bolt</span>
        ...
        >
          <div className="flex justify-between items-start">
            ...
            <span className="material-symbols-outlined notranslate text-yellow-500 text-xl group-hover:scale-110 transition-transform" translate="no">schedule</span>
          </div>
          <div>
            ...
            <div className="flex items-center gap-1 text-xs text-yellow-500/80 mt-1">
              <span className="material-symbols-outlined notranslate text-[14px]" translate="no">hourglass_empty</span>
        ...
        >
          <div className="flex justify-between items-start">
            ...
            <span className="material-symbols-outlined notranslate text-exec-blue text-xl group-hover:scale-110 transition-transform" translate="no">pending</span>
          </div>
          <div>
            <p className="text-3xl font-light text-white">{inProgressTasks.length}</p>
            <div className="flex items-center gap-1 text-xs text-exec-blue/80 mt-1">
              <span className="material-symbols-outlined notranslate text-[14px]" translate="no">trending_up</span>
        ...
        >
          <div className="flex justify-between items-start">
            ...
            <span className="material-symbols-outlined notranslate text-exec-green text-xl group-hover:scale-110 transition-transform" translate="no">check_circle</span>
          </div>
          <div>
            ...
            <div className="flex items-center gap-1 text-xs text-exec-green/80 mt-1">
              <span className="material-symbols-outlined notranslate text-[14px]" translate="no">done_all</span>
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-1 bg-[#0A0A0A] border border-exec-border rounded-none p-1 overflow-x-auto whitespace-nowrap scrollbar-hide w-full lg:w-auto">
          ...
          >
            <span className="material-symbols-outlined notranslate text-[14px]" translate="no">check</span> Mis Completadas
          </button>
          <button
          ...
          >
            <span className="material-symbols-outlined notranslate text-[14px]" translate="no">done_all</span> Equipo (Completadas)
          </button>
          <button
          ...
          >
            <span className="material-symbols-outlined notranslate text-[14px]" translate="no">pending_actions</span> Pendientes [{tasks.filter(t => t.status !== 'Completada').length}]
          </button>
          <button
          ...
          >
            <span className="material-symbols-outlined notranslate text-[14px]" translate="no">history</span> Historial [{tasks.length}]
          </button>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex bg-[#0A0A0A] border border-exec-border rounded-none p-1">
            ...
            >
              <span className="material-symbols-outlined notranslate text-[18px]" translate="no">grid_view</span>
            </button>
            <button
              ...
              title="Vista Lista"
            >
              <span className="material-symbols-outlined notranslate text-[18px]" translate="no">view_list</span>
            </button>
          </div>
          ...
          <div className="relative">
            <span className="material-symbols-outlined notranslate absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 text-[18px]" translate="no">search</span>
            <input
              type="text"
              value={searchTerm}
          ...
          <div className="exec-select-container">
            <span className="material-symbols-outlined notranslate absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 text-[18px]" translate="no">filter_list</span>
            <select
              value={statusFilter}
          ...
          {/* Priority Filter */}
          <div className="exec-select-container">
            <span className="material-symbols-outlined notranslate absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 text-[18px]" translate="no">priority_high</span>
            <select
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              {task.group_task_id && (
                                <span className="flex-shrink-0 inline-flex items-center gap-1 px-1.5 py-0.5 bg-exec-blue/10 border border-exec-blue/30 rounded text-[9px] font-bold text-exec-blue uppercase tracking-wide">
                                  <span className="material-symbols-outlined notranslate text-[10px]" translate="no">group</span>
                                  Compartida
                                </span>
                              )}
                            </div>
      ...
      {filteredTasks.length === 0 && (
        <div className="flex flex-col items-center justify-center py-16 px-4">
          <div className="w-16 h-16 rounded-none bg-[#171717] border border-exec-border flex items-center justify-center mb-4">
            <span className="material-symbols-outlined notranslate text-3xl text-gray-600" translate="no">inbox</span>
          </div>
      ...
      <div className="block md:hidden space-y-4 pt-0">
        ...
        <section className="flex justify-between items-center bg-[#0A0A0A] border border-[#262626] rounded-none p-4 shadow-subtle">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-none bg-exec-blue/10 border border-exec-blue/20 flex items-center justify-center">
              <span className="material-symbols-outlined notranslate text-exec-blue text-xl" translate="no">task_alt</span>
            </div>
            <div>
        ...
        <section className="flex gap-3 overflow-x-auto no-scrollbar py-1">
          ...
          >
            <div className="flex justify-between items-start mb-2">
              <span className="material-symbols-outlined notranslate text-exec-blue text-base" translate="no">assignment_ind</span>
          ...
          >
            <div className="flex justify-between items-start mb-2">
              <span className="material-symbols-outlined notranslate text-yellow-500 text-base" translate="no">schedule</span>
          ...
          >
            <div className="flex justify-between items-start mb-2">
              <span className="material-symbols-outlined notranslate text-exec-blue text-base" translate="no">pending</span>
          ...
          >
            <div className="flex justify-between items-start mb-2">
              <span className="material-symbols-outlined notranslate text-exec-green text-base" translate="no">check_circle</span>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            <div className="relative">
              <span className="material-symbols-outlined notranslate absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-lg" translate="no">search</span>
              <input
                type="text"
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="relative">
                <span className="material-symbols-outlined notranslate absolute left-2.5 top-1/2 -translate-y-1/2 text-gray-500 text-[16px]" translate="no">filter_list</span>
                <select
                  value={statusFilter}
                  onChange={(e) => setStatusFilter(e.target.value)}
              ...
              <div className="relative">
                <span className="material-symbols-outlined notranslate absolute left-2.5 top-1/2 -translate-y-1/2 text-gray-500 text-[16px]" translate="no">priority_high</span>
                <select
                  value={priorityFilter}
                  onChange={(e) => setPriorityFilter(e.target.value)}
                  className="w-full bg-[#0D0D0D] border border-[#262626] rounded-none pl-8 pr-2 py-2 text-[10px] font-bold text-gray-400 uppercase tracking-wider outline-none focus:border-exec-blue/50"
          ...
          <div className="grid grid-cols-2 gap-3 pb-24">
            {filteredTasks.length > 0 ? (
              ...
              <div className="col-span-2 flex flex-col items-center justify-center py-16 bg-[#0A0A0A] border border-dashed border-[#262626] rounded-none">
                <span className="material-symbols-outlined notranslate text-4xl text-[#262626] mb-4" translate="no">inbox_customize</span>
            ...
            <div className="p-4 sm:p-6 bg-[#0A0A0A] flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="p-2 bg-exec-blue/10 rounded-none border border-exec-blue/20">
                  <span className="material-symbols-outlined notranslate text-exec-blue text-2xl" translate="no">smart_toy</span>
                </div>
                <div>
              ...
              >
                <span className="material-symbols-outlined notranslate text-gray-400 text-xl" translate="no">close</span>
              </button>
            </div>
