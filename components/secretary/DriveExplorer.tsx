                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div className="flex-1">
                        ...
                        <h1 className="text-xl font-black text-white uppercase tracking-tighter flex items-center gap-3 font-inter leading-none">
                            <span className="material-symbols-outlined notranslate text-exec-blue text-2xl" translate="no">
                                {icon || 'folder_open'}
                            </span>
                            <span>
            ...
            <div className="px-4 md:px-6 py-2 border-b border-exec-border/30 bg-[#050505]">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-1 overflow-x-auto scrollbar-hide py-1">
                        ...
                        >
                            <span className="material-symbols-outlined notranslate text-[18px]" translate="no">home</span>
                        ...
                        {(currentPath || '').split('/').filter(Boolean).map((part, i, arr) => {
                            ...
                            return (
                                <div key={i} className="flex items-center">
                                    <span className="material-symbols-outlined notranslate text-[14px] text-gray-700" translate="no">chevron_right</span>
                                    <button
            ...
            <div className="flex-1 overflow-y-auto px-4 md:px-6 py-4 relative custom-scrollbar">
                ...
                {filteredItems.length === 0 && !loading && (
                    <div className="flex flex-col items-center justify-center h-full py-24 text-gray-600 border border-dashed border-exec-border rounded-sm bg-[#0D0D0D]">
                        <span className="material-symbols-outlined notranslate text-6xl mb-6 text-exec-border opacity-50" translate="no">folder_off</span>
                                ...
                                <div className="flex items-center justify-center">
                                    {item.type === 'folder' ? (
                                        ...
                                        <div className="w-14 h-14 flex items-center justify-center group-hover:scale-105 transition-transform">
                                            <span className="material-symbols-outlined notranslate text-4xl text-gray-400 group-hover:text-exec-blue transition-colors" translate="no">description</span>
                                        </div>
                                    )}
                                </div>
                                    ...
                                    >
                                        <td className="px-6 py-4 flex items-center gap-4 font-bold text-gray-300 group-hover:text-exec-blue transition-colors">
                                            {item.type === 'folder' ? (
                                                ...
                                                <span className="material-symbols-outlined notranslate text-[20px]" translate="no">description</span>
                                            )}
                                            {item.name}
                                        </td>
                                        ...
                                        <td className="px-6 py-4 text-right">
                                            ...
                                            >
                                                <span className="material-symbols-outlined notranslate text-[18px]" translate="no">more_vert</span>
                                            </button>
                                        </td>
                                    </tr>
                                ))}
                    ...
                    <div className="bg-[#0A0A0A] border border-exec-border rounded-sm max-w-6xl w-full max-h-[92vh] overflow-hidden flex flex-col shadow-2xl">
                        <div className="p-6 border-b border-exec-border flex items-center justify-between bg-[#0D0D0D]">
                            <div className="flex items-center gap-4">
                                <span className="material-symbols-outlined notranslate text-2xl text-exec-blue" translate="no">description</span>
                                <div>
                        ...
                        <div className="flex-1 overflow-auto p-4 flex items-center justify-center bg-black/60">
                            {previewFile.name.toLowerCase().endsWith('.pdf') ? (
                                ...
                                <div className="text-center space-y-6 p-20">
                                    <span className="material-symbols-outlined notranslate text-7xl text-gray-800" translate="no">draft</span>
                ...
                >
                    ...
                    >
                        <div className="flex items-center gap-5 border-b border-exec-border pb-6">
                            <span className="material-symbols-outlined notranslate text-4xl text-exec-blue" translate="no">
                        ...
                        <div className="space-y-3">
                            {selectedItem.url && (
                                ...
                                >
                                    <span className="material-symbols-outlined notranslate text-sm" translate="no">download</span> Descargar / Abrir
                                </a>
                            )}
                            ...
                            >
                                <span className="material-symbols-outlined notranslate text-sm" translate="no">edit</span> Renombrar
                            </button>
                            ...
                            >
                                <span className="material-symbols-outlined notranslate text-sm" translate="no">delete</span> Eliminar
                            </button>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="bg-[#0A0A0A] border border-exec-border rounded-sm p-8 w-full max-w-md shadow-2xl space-y-6 animate-in zoom-in-95 duration-200">
                        <div className="flex justify-between items-center border-b border-exec-border pb-4">
                            <h3 className="text-lg font-bold text-white uppercase tracking-widest flex items-center gap-3 font-orbitron">
                                <span className="material-symbols-outlined notranslate text-exec-blue" translate="no">create_new_folder</span>
                                Nueva Carpeta
                            </h3>
                            <button onClick={() => setIsCreateModalOpen(false)}>
                                <span className="material-symbols-outlined notranslate text-gray-500 hover:text-white" translate="no">close</span>
                            </button>
                        </div>
            ...
            {itemToRename && (
                ...
                >
                    <div className="bg-[#0A0A0A] border border-exec-border rounded-sm p-8 w-full max-w-md shadow-2xl space-y-6 animate-in zoom-in-95 duration-200">
                        <div className="flex justify-between items-center border-b border-exec-border pb-4">
                            <h3 className="text-lg font-bold text-white uppercase tracking-widest flex items-center gap-3 font-orbitron">
                                <span className="material-symbols-outlined notranslate text-exec-blue" translate="no">edit</span>
                                Renombrar Recurso
                            </h3>
                ...
                <div className="fixed inset-0 bg-black/95 backdrop-blur-xl z-[120] flex items-center justify-center p-4 animate-in fade-in duration-200">
                    <div className="bg-black border border-red-500/30 rounded-sm p-10 w-full max-w-sm shadow-2xl space-y-8 animate-in zoom-in-95 duration-200 text-center">
                        <div className="flex flex-col items-center gap-4 text-red-500">
                            <span className="material-symbols-outlined notranslate text-6xl" translate="no">warning</span>
