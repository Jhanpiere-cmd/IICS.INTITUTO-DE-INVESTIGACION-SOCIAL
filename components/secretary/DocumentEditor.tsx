                            ...
                            <div className="flex flex-col gap-1 items-center">
                                <div className="flex items-center gap-0.5">
                                    ...
                                    <button 
                                        ...
                                        <span className="material-symbols-outlined notranslate text-[18px]" translate="no">format_indent_decrease</span>
                                    </button>
                                    <button 
                                        onMouseDown={(e) => { e.preventDefault(); quillInstance.current?.format('indent', '+1'); }} 
                                        className={`p-1.5 ${t.buttonHover} rounded ${t.toolbarText} transition-all`} 
                                        title="Aumentar Sangría">
                                        <span className="material-symbols-outlined notranslate text-[18px]" translate="no">format_indent_increase</span>
                                    </button>
                                </div>
                            ...
                            <div className="flex items-start justify-between mb-6">
                                <div className="flex items-center gap-4">
                                    <div className="p-2 bg-exec-blue/10 rounded-none border border-exec-blue/20">
                                        <span className="material-symbols-outlined notranslate text-exec-blue text-[24px]" translate="no">smart_toy</span>
                                    </div>
                                    <div>
