...
export const NotificationDropdown: React.FC = () => {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            >
                <span className="material-symbols-outlined notranslate text-[24px]" translate="no">notifications</span>
                {unreadCount > 0 && (
                    ...
                    <div className="max-h-80 overflow-y-auto">
                        {notifications.length === 0 ? (
                            <div className="p-8 text-center text-gray-500">
                                <span className="material-symbols-outlined notranslate text-4xl mb-2 opacity-30" translate="no">notifications_off</span>
