        ...
        <div className={`relative ${className}`}>
            ...
            >
                <div className="flex justify-between items-center mb-1">
                    ...
                    <span className={`material-symbols-outlined notranslate text-[10px] text-gray-600 transition-transform ${isOpen ? 'rotate-180' : ''}`} translate="no">
                        expand_more
                    </span>
                </div>
                <div className="flex items-center gap-2">
                    <span className={`material-symbols-outlined notranslate text-[14px] ${currentProvider.color}`} translate="no">
                    ...
                    <div className="max-h-48 overflow-y-auto custom-scrollbar">
                        {PROVIDERS.map((provider) => (
                            <div key={provider.id}>
                                ...
                                >
                                    <span className={`material-symbols-outlined notranslate text-base ${provider.color}`} translate="no">
                                        {provider.icon}
                                    </span>
                                    ...
                                    {config.provider === provider.id && (
                                        <span className="material-symbols-outlined notranslate text-[12px] text-exec-blue" translate="no">check</span>
                                    )}
                                </button>
